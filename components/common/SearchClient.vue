                ...
                <v-card-text>
                    ...
                    >
                        ...
                        <template v-slot:item.actions="{ item }">
                            <v-btn @click.prevent="setClient(item)" text>
                                Выбрать                            
                            </v-btn>
                        </template>
                    </v-data-table>
...
<script>
    ...
    import { searchClient } from '@/../entities/searchClient'
    ...
    export default {
        ...
        directives: { mask },
        mixins: [ requestsMixin, apiClientMixin, apiUserMixin, datesMixin, baseRefsMixin ],
        watch: {},
        data () {
            var vm = this;
            ...
            return {      
                ...
                searchResults: {
                    headers: [
                        ...
                        { text: 'СНИЛС', sortable: false, value: 'Snils' },
        ...
        methods: {            
            ...
            /**
             * Обработчик результатов поиска клиентов
             */
            search () {
                var vm = this
                ...
                /* model.regionId = OMInsurance.regionId
                model.companyId = OMInsurance.companyId */
                ...
                this.apiPostClientsSearch(model)
                    .then((response) => {                        
                        if (response.result === "OK") {
            ...
            /* clearSearchResults: function () {
                ...
                vm.searchResultsitems = [];
                vm.searchResultsitemsOnPage = [];
                vm.searchResultstotal = undefined;
                vm.searchResultscountPage = 1;
                vm.searchResultssizePage = 20;
                vm.searchResultscurPage = 1;
                vm.searchResultsnextPage = 2;
                vm.searchResultsprevPage = 0;
